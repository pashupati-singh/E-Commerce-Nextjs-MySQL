    ...
    try {
      ...
      if (response.ok) {
        ...
        await new Promise((resolve, reject) => {
          setTimeout(() => {
            reject('Registration failed! Something went wrong.');
          }, 1000);
        });
      } catch (error) {
        setError(error);
            ...
            <div className="rounded-md shadow-sm space-y-4">
              ...
              <div className='mt-6'>
                ...
                <input id="confirmPassword" name="confirmPassword" type="password" autoComplete="new-password" required
                       className={`appearance-none rounded-none relative block w-full px-3 py-2 border placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm ${passwordMismatch ? 'border-red-500' : 'border-gray-300'}`}
